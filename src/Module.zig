...
pub fn intern(mod: *const Module, key: InternPool.Key) Allocator.Error!InternPool.Index {
    return mod.intern_pool.get(mod.gpa, key);
}

pub fn intType(mod: *const Module, signedness: std.builtin.Signedness, bits: u16) Allocator.Error!Type {
